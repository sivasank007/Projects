...
function SideBar() {
    const menuItem=[
        {
            name:"Dashboard",
            sub:[
                {cat:'Sales DB',path:'/dashboard/statistics'},
            ],
            icon:faChessBoard, 
        },
        {
        ...
        },
        {
            ...
            sub:[
                ...
                {cat:'Inovice Details',path:'/dashboard/invoicedetails'},
            ],
    ...
    return ( 
        <div className='pb-3' style={{width:'28%',height:'100vh',background:'white',overflowY:'scroll'}}>
            <h1 className='ps-5 py-3' style={{zIndex:'99', letterSpacing:'5px',background:'rgb(213, 213, 210)',height:'5rem',position:'sticky',top:0,borderBottom:'0.5px solid grey'}}><span style={{color:'orangered'}}>FOOD</span>TECH</h1>
            {menuItem.map(item=>
