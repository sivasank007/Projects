...
function AddProduct () {
    ...
    useEffect(()=>{
        axios.get('http://localhost:5555/need/'+id )
        .then(res=>{
    ...
    function handleUpdate(e){
        ...
        axios.put('http://localhost:5555/update/'+id,{menuitem,price})
        .then(res=>{
            if(res.data.updated){
                alert('Updated')
            }
        ...
        <div style={{width:'100%'}}>
            ...
            <form style={{height:'100%'}} className="row" >
                ...
                <div className="col-5">
                    ...
                    <img className='food_1 py-3 px-3 ps-5' src={'http://localhost:5555/images/'+img} alt="" />
